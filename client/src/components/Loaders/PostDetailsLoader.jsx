...
const PostDetailsLoader = () => {
    return (
        <div className="mt-40 m-20">
            <div className="flex flex-col w-full gap-5 p-2 mx-auto bg-white shadow-lg select-none sm:p-4 sm:h-full rounded-2xl sm:flex-row ">
                <div className="bg-gray-200 h-full sm:h-full sm:w-72 rounded-xl animate-pulse">
                </div>
